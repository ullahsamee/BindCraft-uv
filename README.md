...
<samp>
Install and setup BindCraft in seconds using uv an extremely fast Python package manager. Tested using  Ubuntu 25.04, running Linux kernel 6.16.9 with Python3.12, CUDA 13.0 and jax 0.7.2
<samp>
